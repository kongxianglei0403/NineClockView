package com.kxl.atu.nineclockview;
...
import com.kxl.atu.nineclockview.bean.Point;
import com.kxl.atu.nineclockview.view.NinePointView;
import com.kxl.atu.nineclockview.view.NineSquareView;
...
public class MainActivity extends AppCompatActivity {
            ...
            public void onfinish(LinkedHashMap<String, Point> points) {
                if (isSetPsw) {//已设置好密码了。
                    ...
                    if (isEquals(pswpoints,points)) {
                        ...
                        Toast.makeText(MainActivity.this,"与首次绘制不一致,请再次绘制",Toast.LENGTH_LONG).show();
                        pswpoints.clear();
                    }
                }
    ...
    private void init() {
        ...
        reset.setVisibility(isSetPsw?View.VISIBLE:View.VISIBLE);
    }
